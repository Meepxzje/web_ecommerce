                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.deleteram', ['id' => $i->id]) }}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Xóa</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="addForm" method="post" action="{{ route('admin.storeram') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="ten">Tên ram</label>
        ...
        <div class="modal-content">
            ...
            <form id="editForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit_ten">Tên ram</label>
...
<script>
    $(document).ready(function() {
        $('.edit-button').on('click', function() {
            ...
            $('#edit_id').val(id);
            $('#edit_ten').val(ten);
            var actionUrl = '{{ route("admin.updateram", ":id") }}';
