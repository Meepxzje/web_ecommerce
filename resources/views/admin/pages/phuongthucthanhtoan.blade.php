                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.deletepttt', ['id' => $i->id]) }}" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Xóa</a>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="addForm" method="post" action="{{ route('admin.storepttt') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="ten">Tên Phương thức thanh toán:</label>
        ...
        <div class="modal-content">
            ...
            <form id="editForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit_ten">Tên Phương thức thanh toán:</label>
...
<script>
    $(document).ready(function() {
        $('.edit-button').on('click', function() {
            ...
            $('#edit_id').val(id);
            $('#edit_ten').val(ten);
            var actionUrl = '{{ route("admin.updatepttt", ":id") }}';
